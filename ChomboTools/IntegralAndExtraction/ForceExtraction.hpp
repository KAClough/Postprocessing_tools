  ...
  public:
    ...
    ForceExtraction(SphericalExtraction::params_t &a_params, double a_dt,
        ...
        : SphericalExtraction(a_params, a_dt, a_time, a_first_step,
                              a_restart_time)
    {
        add_var(c_rho, VariableType::diagnostic);
        add_var(c_phi_Re, VariableType::diagnostic);
    }
    ...
    void execute_query(AMRInterpolator<Lagrange<4>> *a_interpolator)
    {
        ...
        // Setup to integrate rho and phi_Re
        std::vector<std::vector<double>> force_integrals(2);
        add_var_integrand(m_rho, force_integrals[m_rho],
                          IntegrationMethod::simpson);
        add_var_integrand(m_phi_Re, force_integrals[m_phi_Re],
                          IntegrationMethod::simpson);
